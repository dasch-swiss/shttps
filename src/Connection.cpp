...
#define HEXTOI(x) (isdigit(x) ? x - '0' : x - 'W')
    ...
    Connection::Connection(Server *server_p, std::istream *ins_p, std::ostream *os_p, const string &tmpdir_p,
                           size_t buf_size, size_t buf_inc) : ins(ins_p), os(os_p), _tmpdir(tmpdir_p),
